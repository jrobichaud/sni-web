<script>
    ...
    onMount(() => {
        ...
        selectedSettings = {...defaultPreset, "pot_shuffle": "off", "spoilers": "off"};
    })
    ...
    function presetChanged() {
        if (preset !== "custom") {
            selectedSettings = {...$alttprSettings.presets[preset], "pot_shuffle": "off", "spoilers": "off"};
        }
    }
</script>
...
{#each sections as section}
    <div>
        ...
        {#each section.fields as field}
            <Select label={field.name} bind:value={selectedSettings[field.key]} on:SMUI:action={valueChanged}>
